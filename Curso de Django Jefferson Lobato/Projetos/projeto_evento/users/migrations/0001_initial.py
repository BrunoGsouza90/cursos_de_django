    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(blank=True, null=True, upload_to='profile_photos/', verbose_name='Foto')),
                ('foto_de_capa', models.ImageField(blank=True, null=True, upload_to='cover_photos/', verbose_name='Foto de capa')),
